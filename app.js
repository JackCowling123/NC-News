...
const app = express();
const {getTopics, getAPI, getArticlesID, getAllArticles, getCommentsByArticle, postCommentByArticle, patchArticle, handleDeleteComment} = require('./controllers/controllers.js')
